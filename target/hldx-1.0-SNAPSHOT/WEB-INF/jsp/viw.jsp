...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>css/viw.css" type="text/css">
    <base href="<%=basePath%>" />
</head>
<body id="body">
<%--<p>#{list}</p>--%>
<h3 align="center">欢迎查看保修结果</h3>
<br><br>
<table align="center" id="find" border="1" >

</table>
<br>
<table align="center"> <tr><td>跳转到第几页：</td><td><input type="text" id="ye" value="1"></td><td><input type="button" id="btn" value="查询"></td></tr>
                </table>
